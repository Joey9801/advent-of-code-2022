...
/// item type carried by all three Elves. That is, if a group's badge is item type B, then all
/// three Elves will have item type B somewhere in their rucksack, and at most two of the Elves
